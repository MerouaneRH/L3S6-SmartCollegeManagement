...
class InfoForm extends StatelessWidget {
  ...
  InfoForm({super.key, this.role, this.roomId, required this.roomName, this.inProgressCour, this.courTimeRemaning, this.courUpcoming});
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Text(
                          "In Progress",
                          style: TextStyle( fontSize: 13, color: Color.fromRGBO(19, 17, 17, 0.70), fontWeight: FontWeight.w800, fontFamily: 'Poppins',)
                        ),
                      ),
                      const Spacer(),
                      ...
                      if(courTimeRemaning!= null && courTimeRemaning!.isNotEmpty)
                      Container(
                        padding: const EdgeInsets.fromLTRB(5, 0, 5, 0),
                        decoration: BoxDecoration(
                        ...
                        child: Text(
                          ...
                          maxLines: 1,
                          "$courTimeRemaning",
                          style: const TextStyle( fontSize: 13, color: Color.fromRGBO(54, 33, 148, 0.694), fontWeight: FontWeight.w800, fontFamily: 'Poppins',)
                        ),
                      ),
                    ],
                  ),
                  Text(
                    ...
                    style: const TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold ,fontSize: 16, color: Color(0xFF323232),),
                  ),
