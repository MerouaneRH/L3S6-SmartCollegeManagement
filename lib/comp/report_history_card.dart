...
import 'package:Smart_College/report/report.dart' show updateReportStatus;
...
class report_history extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String reportStatus = reportIsSolved && !reportIsInProgress
        ? "Solved"
        : !reportIsSolved && !reportIsInProgress
            ...
            : !reportIsSolved && reportIsInProgress
                ? "In Progress"
                : "Error";
    final Color cardColor = reportIsSolved && !reportIsInProgress
        ? Color.fromRGBO(209, 229, 233, 1)
        : !reportIsSolved && !reportIsInProgress
            ? Color.fromRGBO(232, 230, 230, 1)
            : Color.fromRGBO(213, 233, 240, 1);
    final String cardImage = reportIsSolved && !reportIsInProgress
        ? 'images/check3.png'
        : !reportIsSolved && !reportIsInProgress
            ? 'images/alert9.png'
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                              ...
                              Container(
                                ...
                                child: Text("$reportDate",
                                    ...
                                    style: const TextStyle(
                                      ...
                                      fontFamily: 'Poppins',
                                      color: Color.fromRGBO(72, 82, 98,
                                          1), //color: Colors.blueGrey.shade400
                                    )),
                              ),
                            ],
                          ),
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                height: 41,
                                padding:
                                    const EdgeInsets.fromLTRB(5, 17, 10, 1),
                                //color: Colors.green,
                                child: Text("$timeSinceReport",
                                    style: const TextStyle(
                                      fontSize: 10,
                ...
                !reportIsSolved
                    ? Row(
                        mainAxisAlignment: reportIsInProgress
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              AwesomeDialog(
                                  ...
                                  descTextStyle: TextStyle(
                                      ...
                                      fontSize: 16),
                                  desc:
                                      'Are you sure you want to mark this as Solved?',
                                  btnCancelOnPress: () {},
                                  btnOkOnPress: () async {
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:
                                  const Color.fromARGB(255, 68, 77, 94),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30.0),
                              ),
                              minimumSize:
                                  Size(4.h, 40.0.w), // Set desired height
                          ...
                          !reportIsInProgress
                              ? ElevatedButton(
                                  onPressed: () async {
                                    print(
                                        'Mark as In Progress button pressed!');
                                    AwesomeDialog(
                                        context: context,
                                        dialogType: DialogType.question,
                                        animType: AnimType.topSlide,
